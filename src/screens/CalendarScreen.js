      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.monthNav}>
          <TouchableOpacity onPress={nextMonth}>
            <Ionicons name="chevron-forward" size={24} color="#111114" />
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={prevMonth}>
            <Ionicons name="chevron-back" size={24} color="#111114" />
          </TouchableOpacity>
        </View>
            ...
            return (
              <TouchableOpacity key={day} style={[styles.dayCell, sel && styles.dayCellSel, tod && !sel && styles.dayCellToday]} onPress={() => setSelected(day)}>
                ...
                <View style={styles.indicators}>
                  <View style={[styles.dot, { backgroundColor: tod ? '#111114' : '#1b2c3d' }]} />
                </View>
              </TouchableOpacity>
            );
          })}
                ...
                <View style={styles.summaryCard}>
                  <View style={styles.glassesRow}>
                    {Array.from({ length: Math.min(waterGlasses, 8) }).map((_, i) => (
                      <Ionicons key={i} name="water" size={14} color="#111114" />
                    ))}
                  </View>
...
const styles = StyleSheet.create({
  ...
  dayCellSel: { backgroundColor: '#111114' },
  ...
  dayNumToday: { color: '#111114', fontWeight: '800' },
  ...
  waterPct: { color: '#111114', fontSize: 14, fontWeight: '700' },
  waterBar: { height: 8, backgroundColor: '#23384c', borderRadius: 4, overflow: 'hidden', marginBottom: 8 },
  waterFill: { height: '100%', backgroundColor: '#111114', borderRadius: 4 },
