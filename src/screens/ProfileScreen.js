...
const GOALS = [
  ...
  { key: 'gain_weight', label: 'עלייה במשקל',  color: '#3a7a4a' },
];
...
const makeStyles = (C) => StyleSheet.create({
  ...
  optBtnActive: { backgroundColor: '#3a7a4a', borderColor: '#3a7a4a' },
  optTxt: { color: C.textDim, fontSize: 13 },
  optTxtActive: { color: '#ffffff', fontWeight: '700' },
  ...
  chipGreen: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 16, backgroundColor: '#0a2a1a', borderWidth: 1, borderColor: '#3a7a4a' },
  chipGreenTxt: { color: '#3a7a4a', fontSize: 13 },
