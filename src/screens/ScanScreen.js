...
function BarcodeTab() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.tabContent}>
      {loading ? (
        <View style={styles.center}><ActivityIndicator color="#111114" size="large" /><Text style={styles.loadingTxt}>מחפש מוצר...</Text></View>
      ) : result ? (
    ...
    <ScrollView contentContainerStyle={styles.tabContent}>
      ...
      {loading && (
        <View style={styles.loadingCard}>
          <ActivityIndicator color="#111114" size="large" />
          ...
          {items.map((item, i) => (
            <View key={i} style={styles.foodRow}>
              <View style={styles.foodMacros}>
                ...
                <Text style={[styles.foodMacro, { color: '#111114' }]}>{item.calories ?? 0} קק"ל</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  tabLine: { position: 'absolute', bottom: 0, left: 0, right: 0, height: 2, backgroundColor: '#111114' },
  ...
  scanFrame: { width: 240, height: 160, borderWidth: 2, borderColor: '#111114', borderRadius: 12 },
  ...
  primaryBtn: { margin: 16, backgroundColor: '#111114', borderRadius: 12, padding: 14, alignItems: 'center' },
