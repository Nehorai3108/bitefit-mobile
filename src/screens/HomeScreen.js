      ...
      <View style={styles.detailContainer}>
        ...
        <ScrollView contentContainerStyle={styles.detailBody} showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity
            ...
            onPress={onAte}
          >
            <Ionicons name={ate ? 'checkmark-circle' : 'restaurant'} size={18} color={ate ? '#3a7a4a' : '#fff'} />
            <Text style={[styles.detailAteTxt, ate && { color: '#3a7a4a' }]}>{ate ? 'נרשם ביומן!' : 'אכלתי את זה'}</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
    </Modal>
      ...
      <View style={styles.recipeBody}>
        ...
        <View style={styles.cardActions}>
          ...
          <TouchableOpacity style={[styles.ateBtn, ate && styles.ateBtnDone]} onPress={handleAte}>
            <Ionicons name={ate ? 'checkmark-circle' : 'restaurant'} size={14} color={ate ? '#3a7a4a' : '#fff'} />
            <Text style={[styles.ateTxt, ate && { color: '#3a7a4a' }]}>{ate ? 'נרשם!' : 'אכלתי את זה'}</Text>
          </TouchableOpacity>
        </View>
      </View>
          ...
          <View style={{ flexDirection: 'row-reverse', alignItems: 'center', gap: 8 }}>
            ...
            {adaptedTarget?.bank_adjustment !== 0 && adaptedTarget?.bank_adjustment != null && (
              <View style={[styles.bankChip, { backgroundColor: adaptedTarget.bank_adjustment > 0 ? '#1a3a2a' : '#3a1a1a' }]}>
                <Text style={[styles.bankChipTxt, { color: adaptedTarget.bank_adjustment > 0 ? '#3a7a4a' : '#ef7d6c' }]}>
...
const makeStyles = (C) => StyleSheet.create({
  ...
  ateBtnDone: { backgroundColor: '#0a2a1a', borderWidth: 1, borderColor: '#3a7a4a' },
