...
const EX = {
  ...
  dips:         { name: 'מקבילים',                   muscles: 'חזה תחתון, טריצפס', tip: 'הטה קדימה לחזה, ישר לטריצפס. ירידה מבוקרת' },
  // גב
  ...
  pullup:       { name: 'פולאפ',                     muscles: 'גב רחב, ביצפס',     tip: 'תפס רחב, דחוף את המרפקים לכיסא הדמיוני למטה, לא תנופה' },
  latPull:      { name: 'משיכת פולי עליון',          muscles: 'גב רחב, ביצפס',     tip: 'חזה מוצב למעלה, משוך לחזה העליון, לאט למעלה' },
  ...
  lunge:        { name: 'לאנג\'ים הליכה',            muscles: 'ירכיים, ישבן, שוק', tip: 'צעד גדול, ברך אמורה לא לגעת ברצפה, גוף ישר' },
  bulgarianSS:  { name: 'בולגרי ספליט סקוואט',      muscles: 'ירכיים, ישבן',       tip: 'כף הרגל האחורית על ספסל, ירידה אנכית, ברך קדמית מעל אצבעות' },
  calf:         { name: 'עלייה על בהונות (עגל)',    muscles: 'שוק',                tip: 'עלייה מלאה, עצור שנייה למעלה, ירידה מלאה מתחת לרצפה' },
  // ביצפס/טריצפס
  ...
  skullCrush:   { name: 'כתישת גולגולת',          muscles: 'טריצפס',            tip: 'מרפקים זקופים, הורד לאחר הראש, לא לצדדים' },
  // ליבה
  ...
  vUp:          { name: 'קיפולי V',                 muscles: 'בטן מלאה',           tip: 'הרם רגליים וגו בו זמנית לכיוון אחד' },
};
...
const HIIT_WORKOUTS = [
  {
    ...
    exercises: [
      { name: 'ברפי', muscles: 'גוף מלא', tip: 'כפוף ברכיים לרצפה, קפוץ לפלאנק, חזור למעלה עם קפיצה', sets: 8, reps: '20 שניות', rest: '10 שניות' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'High Knees', muscles: 'ליבה, קרדיו', tip: 'ברכיים לגובה הישבן, מהיר', sets: 3, reps: '30 שניות', rest: '30 שניות' },
